...
# ============================================================
# DEFINICION DE LA TOPOLOGIA Y RUTAS (TEST 3 - Solo PC1 y PC3)
# ============================================================
...
TOPOLOGIA = [
    {
        "equipo": "PC1",
        "ip": "192.168.0.148",
        "archivo_salida": "TEST_3_PC1_Resultados.xlsx",
        "pruebas": [
            {"id": "P1", "nombre": "Prueba 1", "pc_csv": r"D:\Archivos de Programa\CapturasWS\PC1_TELETRAFICO\TEST 3\PC1T3_1.csv", "sv_csv": r"D:\Archivos de Programa\CapturasWS\SV\TEST 3\SVT3_P1.csv"},
            {"id": "P2", "nombre": "Prueba 2", "pc_csv": r"D:\Archivos de Programa\CapturasWS\PC1_TELETRAFICO\TEST 3\PC1T3_2.csv", "sv_csv": r"D:\Archivos de Programa\CapturasWS\SV\TEST 3\SVT3_P2.csv"},
            {"id": "P3", "nombre": "Prueba 3", "pc_csv": r"D:\Archivos de Programa\CapturasWS\PC1_TELETRAFICO\TEST 3\PC1T3_3.csv", "sv_csv": r"D:\Archivos de Programa\CapturasWS\SV\TEST 3\SVT3_P3.csv"}
        ]
    },
    {
        "equipo": "PC3",
        "ip": "192.168.0.186",  # <--- CAMBIAR AQUI LA IP DE PC3
        "archivo_salida": "TEST_3_PC3_Resultados.xlsx",
        "pruebas": [
            {"id": "P1", "nombre": "Prueba 1", "pc_csv": r"D:\Archivos de Programa\CapturasWS\PC3_TELETRAFICO\TEST 3\PC3T3_1.csv", "sv_csv": r"D:\Archivos de Programa\CapturasWS\SV\TEST 3\SVT3_P1.csv"},
            {"id": "P2", "nombre": "Prueba 2", "pc_csv": r"D:\Archivos de Programa\CapturasWS\PC3_TELETRAFICO\TEST 3\PC3T3_2.csv", "sv_csv": r"D:\Archivos de Programa\CapturasWS\SV\TEST 3\SVT3_P2.csv"},
            {"id": "P3", "nombre": "Prueba 3", "pc_csv": r"D:\Archivos de Programa\CapturasWS\PC3_TELETRAFICO\TEST 3\PC3T3_3.csv", "sv_csv": r"D:\Archivos de Programa\CapturasWS\SV\TEST 3\SVT3_P3.csv"}
        ]
    }
]
...
# ============================================================
print("=" * 80)
print("     INICIANDO PROCESAMIENTO MASIVO DE TOPOLOGIA (TEST 3 - PC1 y PC3)")
print("=" * 80)
...
print("\n" + "=" * 80)
print("             ANALISIS DEL TEST 3 FINALIZADO COMPLETAMENTE")
print("=" * 80 + "\n")